...
class Function(BaseEntrypoint):
    ...
    def check_conf(self):
        ...
        if not (self.alto_wkdir / self.src / f"{self.module}.py").is_file():
            raise ValueError(
                f"could not find module {str(self.alto_wkdir / self.src / f'{self.module}.py')}"  # noqa: E501
            )
...
class Jupyter(BaseEntrypoint):
    ...
    def __init__(self, entrypoint_conf: Dict[str, Any], alto_wkdir: Path):
        super().__init__(entrypoint_conf, alto_wkdir)
    ...
    def check_conf(self):
        ...
        full_nb_path = Path(self.alto_wkdir / self.src / self.notebook_path)
        ...
        parent_dir_output_path = Path(self.alto_wkdir / self.src / self.output_path).parent  # noqa: E501
