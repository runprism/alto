...
from alto.tests.infras import (  # noqa
    base_tests,
    ec2_tests,
)
...
def test_bad_types():
    ...
    with pytest.raises(ValueError) as cm:
        _ = BaseInfra(infra_conf=conf, alto_wkdir=INFRA_WKDIR)
...
def test_normal_ec2_infra():
    ...
    infra = Ec2Infra(infra_conf=conf, alto_wkdir=INFRA_WKDIR)
...
def test_bad_ec2():
    ...
    with pytest.raises(ValueError) as cm:
        _ = Ec2Infra(infra_conf=conf, alto_wkdir=INFRA_WKDIR)
